<template>
    <div>
        <p>
            Hero Souls Protocol is a set of smart contracts built on the Canto blockchain that allows users to create unique NFTs called Souls.
        </p>
        <p>
        ...
        <p>
            There will be a limited genesis mint of 2500 Souls, which will be the 0 generation.
        </p>
        <p>
            After the genesis mint, new Souls can only be created by spawning from two Souls, combining their traits.
        </p>
        <p>
